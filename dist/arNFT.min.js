...
! function(e, n, i, o, r, d, s, c, l, m) {
var u, g, v, p, h, f, w, y, b, E, M, k, x, S = document.createElement("canvas"),
T = S.getContext("2d"),
...
return void
function(e) {
var n, i, o, r = self.origin;
console.debug("Base path:", r);
var d = /https?:\/\/(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#()?&//=]*)/gim.test(e.artoolkitUrl);
1 == d ? n = e.artoolkitUrl : 0 == d && (e.addPath ? (console.debug("addPath exist: ", e.addPath), n = r + "/" + e.addPath + "/" + e.artoolkitUrl) : n = r + "/" + e.artoolkitUrl);
console.debug("Importing WASM lib from: ", n), importScripts(n), self.addEventListener("artoolkitNFT-loaded", (function() {
var n = /https?:\/\/(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#()?&//=]*)/gim.test(e.camera_para);
1 == n ? i = e.camera_para : 0 == n && (i = e.addPath ? r + "/" + e.addPath + "/" + e.camera_para : r + "/" + e.camera_para), console.debug("Loading camera at:", i);
var d = new ARCameraParamNFT(i, (function() {
var n = (t = new ARControllerNFT(e.pw, e.ph, d)).getCameraMatrix();
t.addEventListener("getNFTMarker", (function(e) {
a = {
type: "found",
matrixGL_RH: JSON.stringify(e.data.matrixGL_RH),
proj: JSON.stringify(n)
}
}));
var i = /https?:\/\/(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#()?&//=]*)/gim.test(e.marker);
1 == i ? o = e.marker : 0 == i && (o = e.addPath ? r + "/" + e.addPath + "/" + e.marker : r + "/" + e.marker), console.debug("Loading NFT marker at: ", o), t.loadNFTMarker(o, (function(e) {
...
function I() {
T.fillStyle = "black", T.fillRect(0, 0, b, E), T.drawImage(i, 0, 0, u, g, M, k, w, y);
var e = T.getImageData(0, 0, b, E);
x.postMessage({
type: "process",
imagedata: e
}, [e.data.buffer])
...
(function() {
u = o, g = r, h = 320 / Math.max(u, g / 3 * 4), f = /Android|mobile|iPad|iPhone/i.test(navigator.userAgent) ? window.outerWidth / o : 1, v = u * f, p = g * f, w = u * h, y = g * h, b = Math.max(w, y / 3 * 4), E = Math.max(y, w / 4 * 3), M = (b - w) / 2, k = (E - y) / 2, S.style.clientWidth = b + "px", S.style.clientHeight = E + "px", S.width = b, S.height = E, R.setSize(v, p);
var e = new Blob([N.toString().replace(/^function .+\{?|\}$/g, "")], {
type: "text/js-worker"
}),
t = URL.createObjectURL(e);
(x = new Worker(t)).postMessage({
type: "load",
pw: b,
ph: E,
...
audio: !1,
video: f
}).then(p, m) : window.MediaStreamTrack.getSources((function(e) {
var t = f.facingMode;
l && l.exact && (t = l.exact);
...
break
} l && l.exact && !w.video.mandatory.sourceId ? m("Failed to get camera facing the wanted direction") : navigator.getUserMedia ? navigator.getUserMedia(w, p, m) : m("navigator.getUserMedia is not supported on your browser")
})) : navigator.getUserMedia ? navigator.getUserMedia(w, p, m) : m("navigator.getUserMedia is not supported on your browser")
}(0, n, m, l, o, {
statsMain: d,
statsWorker: s,
stats: i
