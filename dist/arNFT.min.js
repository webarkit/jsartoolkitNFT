...
var g, m, v, p, h, f, w, y, E, b, M, x, S, k = document.createElement("canvas"),
T = k.getContext("2d"),
...
console.debug("Base path:", r), e.addPath ? (console.debug("addPath exist: ", e.addPath), n = r + "/" + e.addPath + "/" + e.artoolkitUrl) : n = r + "/" + e.artoolkitUrl;
console.debug("Importing WASM lib from: ", n), importScripts(n), self.addEventListener("artoolkitNFT-loaded", (function() {
i = e.addPath ? r + "/" + e.addPath + "/" + e.camera_para : r + "/" + e.camera_para, console.debug("Loading camera at:", i);
var n = new ARCameraParamNFT(i, (function() {
var i = (t = new ARControllerNFT(e.pw, e.ph, n)).getCameraMatrix();
...
})), o = e.addPath ? r + "/" + e.addPath + "/" + e.marker : r + "/" + e.marker, console.debug("Loading NFT marker at: ", o), t.loadNFTMarker(o, (function(e) {
...
function I() {
T.fillStyle = "black", T.fillRect(0, 0, E, b), T.drawImage(i, 0, 0, g, m, M, x, w, y);
var e = T.getImageData(0, 0, E, b);
S.postMessage({
type: "process",
imagedata: e
}, [e.data.buffer])
...
(function() {
g = o, m = r, h = 320 / Math.max(g, m / 3 * 4), f = /Android|mobile|iPad|iPhone/i.test(navigator.userAgent) ? window.outerWidth / o : 1, v = g * f, p = m * f, w = g * h, y = m * h, E = Math.max(w, y / 3 * 4), b = Math.max(y, w / 4 * 3), M = (E - w) / 2, x = (b - y) / 2, k.style.clientWidth = E + "px", k.style.clientHeight = b + "px", k.width = E, k.height = b, R.setSize(v, p);
...
i = E / w,
o = b / y;
n[0] *= i, n[4] *= i, n[8] *= i, n[12] *= i, n[1] *= o, n[5] *= o, n[9] *= o, n[13] *= o, a(P.projectionMatrix, n);
break;
case "endLoading":
if(1 == t.end) {
var r = document.getElementById("loading");
