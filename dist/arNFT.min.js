...
var g, m, v, p, h, f, w, y, E, M, x, b, S, k = document.createElement("canvas"),
T = k.getContext("2d"),
...
var H = function(e) {
A = e ? JSON.parse(e.matrixGL_RH) : null
},
I = Date.now();

function j() {
T.fillStyle = "black", T.fillRect(0, 0, E, M), T.drawImage(i, 0, 0, g, m, x, b, w, y);
...
if(e - I, I = e, A) {
l.visible = !0;
for(var n = 0; n < 16; n++) t.delta[n] = A[n] - t.interpolated[n], t.interpolated[n] = t.interpolated[n] + t.delta[n] / 24;
a(l.matrix, t.interpolated)
} else l.visible = !1;
R.render(U, L)
};
(function() {
g = o, m = r, h = 320 / Math.max(g, m / 3 * 4), f = /Android|mobile|iPad|iPhone/i.test(navigator.userAgent) ? window.outerWidth / o : 1, v = g * f, p = m * f, w = g * h, y = m * h, E = Math.max(w, y / 3 * 4), M = Math.max(y, w / 4 * 3), x = (E - w) / 2, b = (M - y) / 2, k.style.clientWidth = E + "px", k.style.clientHeight = M + "px", k.width = E, k.height = M, R.setSize(v, p);
...
l(e), i.stop()
})), i.paused || g.forEach((function(e) {
window.removeEventListener(e, m, !0)
})))
};
g.forEach((function(e) {
window.addEventListener(e, m, !0)
}));
var v = function(e) {
if(window.URL.createObjectURL) try {
i.srcObject = e
} catch (e) {}
i.srcObject = e, u = !0, i.autoplay = !0, i.playsInline = !0, m()
},
p = {},
h = {};
