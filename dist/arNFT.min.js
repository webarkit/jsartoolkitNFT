...
function(e) {
var n, i = self.origin;
console.debug("Base path:", i), e.addPath ? (console.debug("addPath exist: ", e.addPath), n = i + "/" + e.addPath + "/" + e.artoolkitUrl) : n = i + "/" + e.artoolkitUrl;
console.debug("Importing WASM lib from: ", n), importScripts(n), self.addEventListener("artoolkitNFT-loaded", (function() {
var n = i + "/" + e.camera_para;
console.debug("Loading camera at:", n);
var o = new ARCameraParamNFT(n, (function() {
var n = (t = new ARControllerNFT(e.pw, e.ph, o)).getCameraMatrix();
