...
this.width = e, this.height = t, this.root = new THREE.Object3D, this.root.matrixAutoUpdate = !1, this.config = a, this.listeners = {}, this.version = "0.5.0", console.log("ARnft ", this.version)
};
...
var m = l.videoSettings.facingMode || "environment",
u = l.onError || function(e) {
...
! function(t, n, o, r, d, s, c, l, m, u) {
var g, v, h, p, f, w, y, E, b, k, x, M, S, P = document.createElement("canvas"),
T = P.getContext("2d"),
...
U.setPixelRatio(e.devicePixelRatio);
...
function I() {
T.fillStyle = "black", T.fillRect(0, 0, b, k), T.drawImage(o, 0, 0, g, v, x, M, y, E);
var e = T.getImageData(0, 0, b, k);
S.postMessage({
type: "process",
imagedata: e
}, [e.data.buffer])
...
i(m.matrix, a.interpolated)
} else m.visible = !1;
U.render(R, A)
};
(function() {
g = r, v = d, f = 320 / Math.max(g, v / 3 * 4), w = /Android|mobile|iPad|iPhone/i.test(navigator.userAgent) ? e.outerWidth / r : 1, h = g * w, p = v * w, y = g * f, E = v * f, b = Math.max(y, E / 3 * 4), k = Math.max(E, y / 4 * 3), x = (b - y) / 2, M = (k - E) / 2, P.style.clientWidth = b + "px", P.style.clientHeight = k + "px", P.width = b, P.height = k, U.setSize(h, p);
...
u(e), t._teardownVideo(r)
})), r.paused || v.forEach((function(t) {
e.removeEventListener(t, h, !0)
})))
};
...
r.srcObject = t, g = !0, r.autoplay = !0, r.playsInline = !0, h()
},
f = {},
w = {};
...
w.facingMode = m, w.deviceId = l.videoSettings.deviceId, navigator.getUserMedia = navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia || navigator.msGetUserMedia;
var y = {
audio: !1,
video: f
};
...
audio: !1,
video: w
}).then(p, u) : e.MediaStreamTrack.getSources((function(e) {
var t = w.facingMode;
m && m.exact && (t = m.exact);
...
break
} m && m.exact && !y.video.mandatory.sourceId ? u("Failed to get camera facing the wanted direction") : navigator.getUserMedia ? navigator.getUserMedia(y, p, u) : u("navigator.getUserMedia is not supported on your browser")
})) : navigator.getUserMedia ? navigator.getUserMedia(y, p, u) : u("navigator.getUserMedia is not supported on your browser")
}(0, n, u, m, r, {
statsMain: s,
statsWorker: c,
stats: o
